...
<html>
    ...
    <body>
        ...
        <div id="show-tipoProducto" class="content scaffold-show" role="main">
            ...
            <f:display bean="tipoProducto" />
            <g:form resource="${this.tipoProducto}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tipoProducto}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
